...
import { Card, Table, Tag, Button, Input, Select, DatePicker, message, Modal, Statistic, Empty, Switch } from "antd";
import { Users, AlertTriangle, Calendar, Clock, MessageSquare, Shield } from "lucide-react";
...
type Props = {
  data: { students: Student[]; recommendations: Recommendation[]; meetings: Meeting[]; stats: Stats };
};
